...
const categories: readonly Category[] = [
  ...
  { title: '데이터베이스', desc: 'N+1, 쿼리 튜닝, 트랜잭션, 샤딩', link: '/pocket-senior/database/', icon: '🗄️', count: 8, gradient: 'linear-gradient(135deg, rgba(245,158,11,0.12), rgba(167,139,250,0.08))' },
  { title: '아키텍처 & 비동기', desc: 'MSA, Kafka, 메시지큐, 분산 트랜잭션', link: '/pocket-senior/architecture/', icon: '🏗️', count: 6, gradient: 'linear-gradient(135deg, rgba(168,85,247,0.12), rgba(167,139,250,0.08))' },
